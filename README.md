...
Phân tích trắc lượng thư mục là một phương pháp phổ biến và nghiêm ngặt để khám phá và phân tích khối lượng lớn dữ liệu khoa học. Nó cho phép chúng ta giải mã các sắc thái tiến hóa của một lĩnh vực cụ thể, đồng thời làm sáng tỏ các lĩnh vực mới nổi trong lĩnh vực đó. Tuy nhiên, việc áp dụng phương pháp này còn khá mơ hồ và chưa ứng dụng rộng rãi với học viên. Vì vậy, khoá học này nhằm cung cấp phương pháp trắc lượng thư mục, đặc biệt tập trung vào các kỹ thuật khác nhau, đồng thời đưa ra các hướng dẫn từng bước để thực hiện phân tích một cách nghiêm ngặt. Để đạt được mục tiêu này, chúng ta cũng làm sáng tỏ thời điểm và cách thức sử dụng phân tích trắc lượng thư mục so với các kỹ thuật tương tự khác như phân tích tổng hợp và đánh giá tài liệu có hệ thống. 
...
- Khám phá cấu trúc trí tuệ của một lĩnh vực cụ thể trong tập hợp các bài báo
  
Dữ liệu trong phân tích trắc lượng thư mục có xu hướng lớn (ví dụ: hàng trăm đến hàng nghìn) và có tính chất khách quan (ví dụ: số lượng trích dẫn, số lần xuất hiện của từ khóa và chủ đề). Bibliometric analysis rất hữu ích cho việc giải mã và lập bản đồ kiến thức khoa học. Do đó, các nghiên cứu trắc lượng thư mục được thực hiện tốt có thể xây dựng nền tảng vững chắc để phát triển một lĩnh vực theo những cách mới và có ý nghĩa. Nó cho phép và trao quyền cho các học giả (1) có được cái nhìn tổng thể toàn diện, (2) xác định các lỗ hổng kiến thức, (3) rút ra được tính mới ý tưởng để đi sâu hơn, và (4) định vị những đóng góp của mình cho lĩnh vực này.
...
Tóm lại, việc sử dụng bất kỳ phương pháp nào trong ba phương pháp trên đều phụ thuộc vào mục tiêu của việc xem xét, tầm quan trọng và tính chất của bài báo thu thập được. Tuy nhiên, các phương pháp đánh giá này vẫn bổ sung cho nhau và mang lại những lợi thế riêng.
...
Các kỹ thuật phân tích trắc lượng thư mục được thể hiện qua hai loại: (1) phân tích hiệu suất và (2) lập bản đồ khoa học. Về bản chất, phân tích hiệu suất tính đến sự đóng góp của các thành phần nghiên cứu, trong khi việc lập bản đồ khoa học tập trung vào mối quan hệ giữa các thành phần nghiên cứu. 
